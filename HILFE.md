...
- **Was soll gespeichert/wiederhergestellt werden?** – Schalter für die Inhalte:
  ...
  - **Browser-Tabs (Safari, Chrome, Edge)** – Speichert alle geöffneten Web- und
    ...
    Browser. Beim Wiederherstellen setzt die App den Browser auf genau diese Tabs;
    vorhandene Tabs und weitere Browser-Fenster werden geschlossen. Firefox-Tabs können ohne
    Browser-Erweiterung nicht zuverlässig
